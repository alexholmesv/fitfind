...
#       post :create, gym: { address: @gym.address, comuna: @gym.comuna, description: @gym.description, latitude: @gym.latitude, longitude: @gym.longitude, name: @gym.name }
#     end
...
#     patch :update, id: @gym, gym: { address: @gym.address, comuna: @gym.comuna, description: @gym.description, latitude: @gym.latitude, longitude: @gym.longitude, name: @gym.name }
#     assert_redirected_to gym_path(assigns(:gym))
#   end
